		...
		try {
			...
			Qr_Code_By_Venocyber_Techr.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Venocyber_Tech.sendMessage(Qr_Code_By_Venocyber_Tech.user.id, { text: 'MEGALODON-MD;;;' + b64data });
	
				   let VENOCYBER_MD_TEXT = `
*_QR CODE CONNECTED SUCCESSFULLY_*
*_Made With 🤍_*
______________________________________
╔════◇
║ *『 WOW YOU CHOOSEN MEGALODON-MD 』*
║ _You Have Completed the First Step to Deploy a Whatsapp Bot._
╚══════════════════════╝
╔═════◇
║  『••• 𝗩𝗶𝘀𝗶𝘁 𝗙𝗼𝗿 𝗛𝗲𝗹𝗽 •••』
║❒ *Ytube:* _youtube.com/@dybytech00
║❒ *Owner:* _https://wa.me/50934960331
║❒ *Repo:* _https://github.com/DybyTech/MEGALODON-MD_
║❒ *WaChannel:* _https://whatsapp.com/channel/0029VatK7Ab6buMGF3Dq6q0V_
╚══════════════════════╝ 
